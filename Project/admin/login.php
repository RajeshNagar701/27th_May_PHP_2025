              ...
              <div class="card-body">
                ...
                <form method="post" >
                  ...
                  <div class="mb-4">
                    ...
                    <input type="password" value="<?php if(isset($_COOKIE['apass'])){ echo $_COOKIE['apass'];}?>" name="password" class="form-control" id="exampleInputPassword1">
                  </div>
                  <div class="d-flex align-items-center justify-content-between mb-4">
                    <div class="form-check">
                      <input class="form-check-input primary" name="rem" type="checkbox" value="" id="flexCheckChecked" checked>
