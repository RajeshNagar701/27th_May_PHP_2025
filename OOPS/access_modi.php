...
public $a=10; // availabale in class and outside class  3
private $b=20;// available only in own class   1
protected $c=30; // available only in own class and inherit class 2
